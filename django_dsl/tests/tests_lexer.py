...
class TestLexer(TestCase):
    ...
    def test_2(self):
        self.lexer.input("key:value and key1:value1 or key2:value2")
        tok = self.lexer.token()
        # print(tok.type, tok.value, tok.lexpos)
        self.assertEqual(tok.type, "FIELD")
        self.assertEqual(tok.value, "key:value")
    ...
    def test_3(self):
        self.lexer.input("(key:value and key1:value1) or not key2:value2 ")
        tok = self.lexer.token()
        # print(tok.type, tok.value, tok.lexpos)
    ...
    def test_fail_1(self):
        self.lexer.input("key1or:vandlue1 ort key2 ")
        tok = self.lexer.token()
        # print(tok.type, tok.value, tok.lexpos)
        self.assertEqual(tok.type, "FIELD")
    ...
    def test_fail_2(self):
        self.lexer.input("key1or:vandlue1 or key2")
        tok = self.lexer.token()
        # print(tok.type, tok.value, tok.lexpos)
        self.assertEqual(tok.type, "FIELD")
        self.assertEqual(tok.value, "key1or:vandlue1")
